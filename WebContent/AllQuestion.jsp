<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="java.util.List,logic.bean.QuestionBean"%>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div
					...
					<br> <a href="InsertQuestion.jsp">
						<button style="background-color: #272F54; width: 100%"
							type="button" class="btn btn-primary btn-lg">Insert new
							question</button>
					</a> <br> <br> <a href="#">
						<button style="background-color: #272F54; width: 100%"
							type="button" class="btn btn-primary btn-lg">My
							question</button> <br> <br> <br> <br> <br> <br>
						<br> <br> <br> <br> <br> </a>
						<a href="prova.jsp">
							<button
								style="background-color: :#272F54; background-color: #272F54; width: 100%"
								type="button" class="btn btn-primary btn-lg">Home page</button>
					</a> <br>
				</div>
			</div>
			<!-- End right menu -->
			...
			<div style="background-color: #F6C640"
				...
				<div>
					...
					<div class="row" style="background-color: white; text-align: left">
						<div class="captation">
							<table class="table-bordered"
								style="width: 100%; height: 100%; border: 5px; border-color: #000">
								<tr>
					...
					%><script>
			alert("Non question for the subbject you follow")
		</script>
					<%
						}
					%>
