<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="java.util.List,logic.bean.SubjectBean"%>
	...
	<div class="container">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="defaultNavbar1">
						<ul class="nav navbar-nav">
							<li class="home"><a href="prova.jsp">Home<span
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div
					...
					<%
						...
						if (value) {
					%>
					<p class="label"><%=(String) session.getAttribute("subject")%></p>
					<form action="${pageContext.request.contextPath}/QuestionServlet"
						name="formQuestionType" method="POST">
						<br>
						<button style="width: 100%; background-color: #272F54"
							name="exercise" type="submit" class="btn btn-primary btn-lg">Exercise</button>
						<br> <br>
						<button style="width: 100%; background-color: #272F54"
							name="problem" type="submit" class="btn btn-primary btn-lg">Problem</button>
						<br>
			...
			<div style="background-color: #F6C640; min-height: 492px;"
				...
				<p class="lead">
					These are the subjects you follow <br>Select one
				</p>
				...
				<form action="InsertQuestion.jsp" method="POST">
					...
					<div class="col-xs-3">
						...
						<input style="width: 100%; background-color: #272F54"
							type="submit" name="materia"
							value="<%=subjects.get(i).getAbbrevation()%>"
							class="btn btn-info"> <input
							style="width: 100%; background-color: #272F54" type="hidden"
							name="<%=subjects.get(i).getAbbrevation()%>"
							value="<%=subjects.get(i).getName()%>"> <br>
						<br>
